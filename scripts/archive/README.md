...
Scripts kept for **historical reference only**. Both are disabled with a hard
`raise SystemExit(...)` guard at the top of the file — they will not run,
whether executed directly or merely `import`ed.
